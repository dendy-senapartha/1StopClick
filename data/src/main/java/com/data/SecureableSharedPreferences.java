...
public class SecureableSharedPreferences implements PreferenceFacade {
    ...
    private SecureableSharedPreferences(Builder builder) {
    ...
    public static class Builder {
        ...
        /**
         * build {@link SecureableSharedPreferences} instance
         *
         * @return {@link SecureableSharedPreferences}
         */
        public SecureableSharedPreferences build() {
            return new SecureableSharedPreferences(this);
        }
    }
}